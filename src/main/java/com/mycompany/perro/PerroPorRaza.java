 ...
 * @author yeimmy
 */
public class PerroPorRaza extends javax.swing.JFrame {
    private String urlBD;
    private Dao<Perro, ?> tablaPerros;
    /**
     * Creates new form PerroPorRaza
     */
    public PerroPorRaza() {
        try{
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Perros Por Raza");

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setText("PERROS POR RAZA");
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(27, 27, 27)
                        .addComponent(raza, javax.swing.GroupLayout.PREFERRED_SIZE, 144, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(layout.createSequentialGroup()
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(cont == 0)
        {
        JOptionPane.showMessageDialog(null, "No existen perros de esa raza");;
        }
        else{
            JOptionPane.showMessageDialog(null, " Hay " + cont + " perros de la raza " + Raza);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerroPorRaza.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerroPorRaza().setVisible(true);
            }
        });
    }
